...
{
    public class CreateNewPaquetAsyncCommand : ACommand<PaquetEntity,CreateNewPaquetAsyncCommand>
    {
        public string Name { get; }
        public string Description { get; }
        public CreateNewPaquetAsyncCommand(string name, string description) 
        {
            this.Name = name;
